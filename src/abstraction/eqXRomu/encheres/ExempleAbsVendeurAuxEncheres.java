...
public class ExempleAbsVendeurAuxEncheres implements IActeur, IMarqueChocolat, IFabricantChocolatDeMarque {
	...
	public ExempleAbsVendeurAuxEncheres(Chocolat choco, String marque, double stock, double prixMin) {	
	...
	public String getNom() {
		return "V.Ench"+this.numero;
	}

	public String getDescription() {
		return "Vendeur aux encheres "+this.numero;
	}
	...
	public List<ChocolatDeMarque> getChocolatsProduits() {
		 ...
		 res.add(new ChocolatDeMarque(choco, marque, (int)(Filiere.LA_FILIERE.getParametre("pourcentage min cacao "+choco.getGamme()).getValeur())));
		return res;
	}
	
	public double getQuantiteEnStock(IProduit p, int cryptogramme) {
		if (this.cryptogramme==cryptogramme) {
			if (p.equals(this.choco)) {
				return this.getStock().getValeur();
			} else{
				return 0;
			}
		} else {
