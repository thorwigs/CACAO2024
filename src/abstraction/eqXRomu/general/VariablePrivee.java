...
public class VariablePrivee extends VariableReadOnly {
	...
	public double getValeur() {
		return Double.NaN; // On ne permet pas la consultation sans precision du cryptogramme
	}
	public Historique getHistorique() {
		return new Historique();// On ne permet pas la consultation sans precision du cryptogramme
	}
