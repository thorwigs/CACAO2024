...
public class MasseSalarialeNouveau extends Producteur1Acteur {
    ...
    public void next() {
		...
		this.getJournaux().get(0).ajouter("Le nombre d'enfants = " + this.get_Nombre_Enfant());

        // Ajout d'une entrée de journal pour les ouvriers équitables formés
        this.getJournaux().get(0).ajouter("Le nombre d'ouvriers équitables formés = " + this.get_Nombre_Ouvrier_Equitable_Forme());

        // Ajout d'une entrée de journal pour les ouvriers équitables non formés
        this.getJournaux().get(0).ajouter("Le nombre d'ouvriers équitables non formés = " + this.get_Nombre_Ouvrier_Equitable_NonForme());

        // Ajout d'une entrée de journal pour les ouvriers non équitables formés
        this.getJournaux().get(0).ajouter("Le nombre d'ouvriers non équitables formés = " + this.get_Nombre_Ouvrier_NonEquitable_Forme());

        // Ajout d'une entrée de journal pour les ouvriers non équitables non formés
        this.getJournaux().get(0).ajouter("Le nombre d'ouvriers non équitables non formés = " + this.get_Nombre_Ouvrier_NonEquitable_NonForme());
        this.getJournaux().get(0).ajouter("indemnite à payer" + this.indemnite_licensiement);
        indemnite_licensiement=0;
    	ordre=0;
