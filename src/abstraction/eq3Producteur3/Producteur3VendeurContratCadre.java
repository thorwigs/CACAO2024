...
public class Producteur3VendeurContratCadre extends Producteur3VendeurBourse implements IVendeurContratCadre {
	...
	public void notificationNouveauContratCadre(ExemplaireContratCadre contrat) {
		...
		this.journal_contrat_cadre.ajouter("Nouveau contrat cadre signé: Contrat N°" + contrat.getNumero() +  ", avec " + contrat.getAcheteur().getNom() +  ", pour " + contrat.getQuantiteTotale() + " tonnes de " + contrat.getProduit().getNom() +    " à " + contrat.getPrix() + " €/T");
