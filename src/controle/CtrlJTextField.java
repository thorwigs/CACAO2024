...
public class CtrlJTextField  implements ActionListener, PropertyChangeListener, IAssermente {
...
//		}
	...
	public void propertyChange(PropertyChangeEvent evt) {
		...
		dc.setGroupingUsed(true);
		int crypto = this.cryptos.get(ind.getCreateur());
		String formattedText = dc.format(ind.getValeur(crypto));
